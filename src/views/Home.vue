     ...
     <ul class="title-list">
       <li
        ...
        <div class="t-summary">
            ...
            <div class="t-inner">
                <span class="t-text">前几天流量小生小花们 齐聚杭州参加中国电影新力量论坛 甭管是片酬上亿的演员 还是多少作品傍身的导演 都认真乖巧端坐着完成近7个小时的学习任务 网友直呼第一次看见谁谁谁同框 若把时间往回调个几年…<a>阅读全文</a></span>
            </div>
          </div>
        <div class="tool-bar">
          <ul class="tb-list">
...
export default {
  ...
  mounted () {
    window.onscroll = (e) => {
      const top_left = document.body.scrollLeft || document.documentElement.scrollLeft
      this.left = -top_left
    }
  }
}
